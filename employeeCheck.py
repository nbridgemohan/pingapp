...
# # grab filtered employees
# country = "Australia"

# print(f"Filtering {country} employees...")
# employees = [employee for employee in employee_data if employee["country"] == country]
# print("Done!")

# # filter data to grab only filtered attendance data
# print(f"Filtering {country} attendance data...")
# employee_ids = [employee["record_id"] for employee in employee_data if employee["country"] == country]
# attendance_data = [entry for entry in attendance_data if entry["employee_record_id"] in employee_ids]
# print("Done!")

# # for debugging purposes
# print("Grabbing debug data for attendance and employees...")
# with open('debug/employees.json', 'w') as outfile:
#     json.dump(employees, outfile, indent=2)
# with open('debug/attendance.json', 'w') as outfile:
#     json.dump(attendance_data, outfile, indent=2)
# print("Done!")


# API endpoints
print("Grabbing weather and event data from APIs")
...
for employee in employee_data:
    ...
    for entry in employee_attendance:
        ...
        # TODO verify with business if this is desired
